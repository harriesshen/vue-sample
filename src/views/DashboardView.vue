...
<template>
  <div class="relative h-full">
    ...
    <div class="mx-auto px-8 ">
      ...
      <!-- Content -->
      <div class="grid grid-cols-1 gap-6 lg:grid-cols-12 flex-1 min-h-0">
        <!-- Sidebar -->
        <Sidebar class="lg:col-span-3" />

        <!-- Main -->
        <main class="lg:col-span-9 min-h-0 flex-1 rounded-xl border border-slate-800 bg-slate-900/40 p-4">
